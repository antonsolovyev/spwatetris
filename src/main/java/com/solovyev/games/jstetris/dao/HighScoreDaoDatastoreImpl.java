...
public class HighScoreDaoDatastoreImpl implements HighScoreDao
{
    ...
    public List<HighScore> getHighScores()
    {
        ...
        Collections.sort(res, Collections.reverseOrder(new Comparator<HighScore>()
                {
                    @Override
                    public int compare(HighScore o1, HighScore o2)
                    {
                        return compareHighScores(o1, o2);
                    }
                }));
    ...
    {
        HighScore res = new HighScore((String) entity.getProperty(NAME_PROPERTY_NAME),
